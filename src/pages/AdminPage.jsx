...
function createFormState(property) {
  ...
  const nextFormState = {
    ...
    subscriptionStartAt: String(property.subscriptionStartAt ?? '').trim(),
    listingFeeAmount: String(property.listingFeeAmount ?? '').trim() || '300',
    listingFeeInterval: String(property.listingFeeInterval ?? '').trim() || 'annual',
...
function buildPropertyDraft(formState) {
  ...
  return {
    ...
    subscriptionStartAt: String(formState.subscriptionStartAt ?? '').trim(),
    listingFeeAmount: String(formState.listingFeeAmount ?? '').trim() || '300',
    listingFeeInterval: String(formState.listingFeeInterval ?? '').trim() || 'annual',
