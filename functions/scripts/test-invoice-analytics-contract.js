...
assert.equal(invoicePdfTest.hasPositiveInvoiceStatNumber(0), false)
assert.equal(invoicePdfTest.hasPositiveInvoiceStatNumber(null), false)
assert.equal(invoicePdfTest.hasPositiveInvoiceStatNumber(1), true)
