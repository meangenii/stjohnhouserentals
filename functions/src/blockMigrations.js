...
const BLOCK_MIGRATION_STEPS = Object.freeze(
  Object.fromEntries(
...
function migrateBlockRecord(block, { expectedType = '', path = [] } = {}) {
  ...
  const supported = SUPPORTED_BLOCK_TYPES.includes(type)
  const errors = []
  const migrations = []
...
function migrateBlockPageDraft(page) {
...
module.exports = {
  BLOCK_MIGRATION_STEPS,
  CURRENT_BLOCK_VERSION,
  SUPPORTED_BLOCK_TYPES,
  migrateBlockPageDraft,
  migrateBlockRecord,
}
